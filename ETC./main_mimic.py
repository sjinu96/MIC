...
class Trainer(object):
    ...
    def setup_network(self):
        model = models.create(cfg.MODEL.TYPE) # X-LAN, X-Tranfsormer
    ...
    def train(self):
        ...
        for epoch in  range(cfg.SOLVER.MAX_EPOCH):
            ...
            for _, (indices, input_seq, target_seq, gv_feat, att_feats, att_mask) in enumerate(self.training_loader):
                ...
                print('input_seq : ', type(input_seq), input_seq.shape)
                print('target_seq : ', type(target_seq), target_seq.shape)
                print('gv_feat : ', type(gv_feat), gv_feat.shape)
                print('att_feats : ', type(att_feats), att_feats.shape)
                print('att_mask :', type(att_mask), att_mask.shape)
