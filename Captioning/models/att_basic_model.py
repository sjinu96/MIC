...
class AttBasicModel(BasicModel):
    ...
    def forward(self, **kwargs): 
        seq = kwargs[cfg.PARAM.INPUT_SENT] # input_seq
        #print("seq.shape:", seq.shape) # [65,201] / [65,177]
        #print("seq:", seq)
        ...
        #print("1 att_feats.shape:", att_feats.shape)
        #print("1 att_feats:", att_feats)
        ...
        for t in range(seq.size(1)):
            if self.training and t >=1 and self.ss_prob > 0:
                ...
                if mask.sum() == 0:
                    ...
                    ind = mask.nonzero(as_tuple=False).view(-1) # changed
                    wt = seq[:, t].data.clone()
            ...
            if t >= 1 and seq[:, t].max() == 0: # if all data at position t in batch is 0, break 
                #print("Break!!!!!!")
                #print("t:", t)
                #print("seq[:, t]:", seq[:, t])
                break
            ...
            outputs[:, t] = logit
        #print("outputs.shape:", outputs.shape) # [65,201,1809] [65,177,1809]
    ...
    def decode_beam(self, **kwargs):
        ...
        for t in range(cfg.MODEL.SEQ_LEN):
            ...
            selected_beam = selected_idx // candidate_logprob.shape[-1] # python2->3 change /->//
