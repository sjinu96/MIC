...
class LowRank(nn.Module):
    def __init__(self, embed_dim, att_type, att_heads, att_mid_dim, att_mid_drop): # 얜 왜 embed_dim / att_heads랑 att_mid_dim을 같이 넣어놨을까..
    ...
    def forward(self, query, key, mask, value1, value2, precompute=False):
        #print("query.size():", query.size()) # [B,256]
        #print("value1.size():", value1.size()) # [B,256]
        #print("value2.size():", value2.size()) # [B,1029,256]
        ...
        # print("attn_map:", attn_map.shape) # [B,head,1029,32] or [B, head, 392, 64]
        # print("mask:", mask.shape)  # [B,1029]
        # print("v1.shape", v1.shape) # [B,head,32]
        # print("v2.shape", v2.shape) # [B,head,1029,32]
