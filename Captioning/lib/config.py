...
__C.DATA_LOADER.LEVERAGE_NORMAL = 'Pair' # Random or CA
__C.DATA_LOADER.NUM_CA = 10

__C.DATA_LOADER.TRAIN_INPUT_IMAGES = 'input' # jsp
__C.DATA_LOADER.TRAIN_NORMAL_IMAGES = 'normal' # jsp
__C.DATA_LOADER.VAL_INPUT_IMAGES = 'input' # jsp
__C.DATA_LOADER.VAL_NORMAL_IMAGES = 'normal' # jsp
__C.DATA_LOADER.TEST_INPUT_IMAGES = 'input' # jsp
__C.DATA_LOADER.TEST_NORMAL_IMAGES = 'normal' # jsp

__C.DATA_LOADER.RESIZE = 256 # jsp
__C.DATA_LOADER.CROP_SIZE = 224 # jsp
...
__C.DATA_LOADER.ALL_ID = 'coco_all_image_id.txt' # changed
...
__C.DATA_LOADER.NORMAL_ID = 'coco_normal_image_id.txt' # changed
...
__C.MODEL.ENCODER_TYPE = 'resnet152' # jsp
__C.MODEL.ENCODER_PRETRAINED = 'ImageNet' # jsp
__C.MODEL.ENCODER_CFG_PATH = 'None' # example.json
__C.MODEL.ENCODER_PRETRAINED_PATH = 'Chexpert.pth' # Chexpert.pth or False (config.yml과 config.py를 동시에 수정해야함 - 혹시 몰라서)
__C.MODEL.ENCODER_FUSION_MODE = 'ewp'
__C.MODEL.ENCODER_FUSION_GRAD = 'no_detach'
__C.MODEL.ENCODER_PROJ ='1x1conv'
__C.MODEL.ENCODER_TRAINING ='Last' # 'Last', 'All'


__C.MODEL.CONTRA_ATT_TYPE ='dot' # 'dot' , 'BiP'
__C.MODEL.CONTRA_ATT_NUM_HEADS = 6 # 6 (default)
__C.MODEL.DROPOUT_CA = 0.3 # 0.3 (Default)
...
__C.SOLVER.LR_POLICY.TYPE = 'ScaledNoam'       # 'Fix', 'Step', 'Noam', 'Plateau', 'ScaledNoam' : 추가
__C.SOLVER.LR_POLICY.SUB_SCHEDULE = False # True or False, Extractor 학습률 조정.
__C.SOLVER.LR_POLICY.STEPS = [60, 150, 230, 310, 380]        # Non-uniform step iterations for 'steps_with_decay' or 'steps_with_lrs' policies
__C.SOLVER.LR_POLICY.GAMMA = 0.2        # For 'step', the current LR is multiplied by SOLVER.GAMMA at each step
...
__C.PARAM.INPUT_IMAGES ='INPUT_IMAGES' # jsp

__C.PARAM.NORMAL_IMAGES = 'NORMAL_IMAGES' # jsp
